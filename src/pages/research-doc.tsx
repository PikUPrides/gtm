      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 pb-20">
        <div className="flex gap-10">
          ...
          <article className="flex-1 min-w-0 max-w-3xl">
            ...
            {/* 09. AV Threat */}
            <section id="av-threat" className="mb-20 scroll-mt-32">
              <SectionHeader
                num="09"
                eyebrow="New · 2026 Strategic Threat"
                title="The Autonomous Vehicle / Robotaxi Threat"
                description="The single biggest variable AYRO faces in Texas. Not in the original doc — added April 2026."
                hot
              />
              <Callout tone="danger" title="Why this section exists">
                Between October 2025 (base doc) and April 2026, robotaxis went from "someday" to "shipping in AYRO's launch
                cities right now." Every strategic plan in this document must be stress-tested against this reality.
              </Callout>
              <h3 className="text-lg font-bold text-[#1D0652] mb-4 mt-8">Current state of robotaxis in Texas</h3>
              <div className="grid sm:grid-cols-2 gap-4 mb-6">
                <Card className="border-red-200">
                  <div className="text-xs font-bold text-red-600 uppercase tracking-wider mb-2">Austin · Live now</div>
                  <div className="text-xl font-extrabold text-[#1D0652] mb-2">Waymo (with Uber)</div>
                  <ul className="text-sm text-gray-700 space-y-1.5 leading-relaxed">
                    <li>• Covers <strong>90 sq miles</strong> of Austin (up from 37 sq mi in mid-2025)</li>
                    <li>• <strong>~20% of Uber rides</strong> in the original operating territory are driverless</li>
                    <li>• 100+ vehicles; 24/7 service</li>
                    <li>• Uber CEO: "busier than 99% of all drivers"</li>
                  </ul>
                </Card>
                <Card className="border-red-200">
                  <div className="text-xs font-bold text-red-600 uppercase tracking-wider mb-2">Austin · Live now</div>
                  <div className="text-xl font-extrabold text-[#1D0652] mb-2">Tesla Robotaxi</div>
                  <ul className="text-sm text-gray-700 space-y-1.5 leading-relaxed">
                    <li>• Paid robotaxi service launched early 2026</li>
                    <li>• Human safety monitors in-car for now</li>
                    <li>• Aggressive expansion plans by Musk</li>
                    <li>• Direct-to-consumer app (bypasses Uber)</li>
                  </ul>
                </Card>
                <Card className="border-amber-200">
                  <div className="text-xs font-bold text-amber-700 uppercase tracking-wider mb-2">Dallas · Launching 2026</div>
                  <div className="text-xl font-extrabold text-[#1D0652] mb-2">Lyft Robotaxis</div>
                  <ul className="text-sm text-gray-700 space-y-1.5 leading-relaxed">
                    <li>• Announced Dallas as first robotaxi city</li>
                    <li>• Multi-city expansion after TX debut</li>
                    <li>• Lyft acquired FREENOW (Jul 2025) — showing AV ambition</li>
                    <li>• Convening driver forums to manage transition</li>
                  </ul>
                </Card>
                <Card className="border-gray-300">
                  <div className="text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">Coming next</div>
                  <div className="text-xl font-extrabold text-[#1D0652] mb-2">Waymo expansion</div>
                  <ul className="text-sm text-gray-700 space-y-1.5 leading-relaxed">
                    <li>• Driverless in 5 cities today, 15 more in 2026+</li>
                    <li>• ~2,500 robotaxis in the US fleet</li>
                    <li>• DC and Miami targeted for 2026</li>
                    <li>• Houston + San Antonio likely 2027</li>
                  </ul>
                </Card>
              </div>
              <h3 className="text-lg font-bold text-[#1D0652] mb-4 mt-8">What this does to the market</h3>
              <div className="space-y-3 mb-8">
                <Callout tone="danger" title="Human driver earnings pressure">
                  Drivers in Phoenix and LA already report <strong>decreased earnings</strong> after Waymo deployment.
                  Texas drivers are next. This is the opportunity — and the clock is ticking on recruiting them to AYRO.
                </Callout>
                <Callout tone="warn" title="Airport competition intensifies">
                  Robotaxi economics are best on short, high-frequency urban loops — NOT airport runs. Drivers are being
                  pushed toward airport trips to survive. AYRO's airport play is <em>more</em> valuable, not less.
                </Callout>
                <Callout tone="warn" title="Suburban coverage shrinks for competitors">
                  Robotaxis will not operate in low-density suburbs for years. Uber/Lyft will divert attention and capital
                  to AV corridors, leaving suburbs even more under-served. AYRO's suburban thesis strengthens.
                </Callout>
              </div>
              <h3 className="text-lg font-bold text-[#1D0652] mb-4 mt-8">AYRO's counter-strategy (recommended)</h3>
              <div className="grid gap-3">
                {[
                  { num: '01', title: 'Recruit AV-displaced drivers aggressively', detail: 'Austin drivers are being squeezed right now. Run direct-response campaigns: "Keep 100% of your fare. No surge games. No AV competition in your zones." This is a 12–18 month window.' },
                  { num: '02', title: 'Own suburbs & exurbs as an AV-immune moat', detail: 'Robotaxis will not operate in Katy, Frisco, Cypress, or Schertz for years. Anchor AYRO\'s brand as "The Suburban Mobility Partner" where robotaxis cannot go.' },
                  { num: '03', title: 'Brand the human driver advantage', detail: 'Lean into "real drivers, real safety, real accountability." Dashcams, verified drivers, and human judgement during events (weather, emergencies, complex pickups) are features robotaxis cannot match.' },
                  { num: '04', title: 'Airport dominance via reliability', detail: 'Robotaxis are unreliable at airports (curbside rules, luggage, cross-terminal). Pre-booked AYRO airport rides should be the TX standard. Partner with DFW, IAH, AUS, SAT.' },
                  { num: '05', title: 'Safety-first late-night ownership', detail: 'Women, students, and families sending a teen home at 1 AM will not trust an empty robotaxi for years. Own this segment before AVs solve trust.' },
                  { num: '06', title: 'Explicitly pro-driver PR', detail: 'Every Waymo / Lyft-AV story in Texas media is a recruiting opportunity. AYRO should have a ready press posture on displaced drivers + a landing page that converts.' },
                  { num: '07', title: 'Hybrid future-proofing (3–5 yr)', detail: 'Do not fight AVs forever. Build a model where AYRO can onboard fleet operators or even Waymo-type partnerships on AYRO\'s terms once the platform has scale and brand equity.' },
                ].map(r => (
                  <div key={r.num} className="rounded-xl border border-[#423DF9]/20 bg-gradient-to-br from-[#423DF9]/5 to-white p-4 flex items-start gap-4">
                    <div className="text-xs font-extrabold bg-gradient-to-br from-[#423DF9] to-[#7742F1] text-white rounded-lg w-10 h-10 flex items-center justify-center flex-shrink-0">{r.num}</div>
                    <div>
                      <div className="font-bold text-[#1D0652] text-sm mb-1">{r.title}</div>
                      <div className="text-xs text-gray-700 leading-relaxed">{r.detail}</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <section id="price-bench" className="mb-20 scroll-mt-32">
              <SectionHeader num="10" eyebrow="Competition" title="Competitive Price Benchmarking" description="Side-by-side comparison and AYRO's unique pricing advantage." />
              <ComparisonTable
