          ...
          <article className="flex-1 min-w-0 max-w-3xl">
            ...
            <section id="recommendations" className="mb-12 scroll-mt-32">
              ...
              <div className="space-y-3">
                {[
                  { rank: '01', priority: 'URGENT', title: 'Launch DFW first — execute the 90-day plan', detail: 'DFW has #2-busiest airport, strong suburban density, Fortune 500 corporate base, and the highest Uber/Lyft surge pain in Texas. Tight geography means AYRO can reach driver density faster than a sprawling Houston launch.' },
                  { rank: '02', priority: 'URGENT', title: 'Recruit the disaffected Uber/Lyft driver pool now', detail: 'Driver earnings are down, deactivations are rising, and Prop 22 lawsuits are making national news. This is the most recruitable driver moment in 5 years. Direct-response ads, driver-to-driver referrals, driver community partnerships.' },
                  { rank: '03', priority: 'HIGH', title: 'Anchor brand on "Suburban Mobility Partner"', detail: 'Uber/Lyft are structurally weak in low-density suburbs because their economics depend on dense trip-stacking. Real TX suburbs (Katy, Sugar Land, Frisco, Plano, Cypress, Round Rock) are the growth engine. Flat-fare suburban-to-metro corridors.' },
                  { rank: '04', priority: 'HIGH', title: 'Own airport reliability in DFW + IAH + AUS', detail: 'Pre-booked airport rides with buffer ETAs. "Never miss your flight" brand promise. Partner with airports and hotels for curbside pickup privileges and corporate expense account integrations.' },
                  { rank: '05', priority: 'HIGH', title: 'Make "Keep 100% of your earnings" the #1 driver message', detail: 'Nothing else cuts through like this. Testimonials, income examples, TikTok content from real drivers. This is the entire hiring campaign — do not dilute it with secondary messages.' },
                  { rank: '06', priority: 'HIGH', title: 'Launch a women-safety ride category', detail: 'Huge unmet demand in TX. Dashcam + verified drivers + female-preferred option. Enormous emotional pull for parents of teens and for women in nightlife districts.' },
                  { rank: '07', priority: 'MEDIUM', title: 'Refresh investor deck with 2026 numbers', detail: 'The October 2025 doc had 72/28 Uber:Lyft — current is 76/24. Updated ride volumes (11.3B Uber / 828M Lyft), +7.5% median price rise, $15.60/hr driver take-home. Sharpens the duopoly-exploitation narrative.' },
                  { rank: '08', priority: 'MEDIUM', title: 'Build driver loyalty flywheel early', detail: '"Pro Driver" tier, weekly badges, clean-car bonus, micro-loans, family medical plans, fuel partnerships. Uber/Lyft cannot copy these without blowing up their commission model — that\'s the moat.' },
                  { rank: '09', priority: 'MEDIUM', title: 'Pre-negotiate specialist TNC insurance', detail: 'Insurance costs rising 12–16% annually. Dashcam data + safety narrative + clean claims record should lock in better rates than peers. Specialist TNC insurers, not general auto.' },
                  { rank: '10', priority: 'LONG-TERM', title: 'B2B corporate ride-credit loops', detail: 'Corporate partner buys bulk ride credits → guaranteed baseline ride volume → driver earnings stabilize → retention improves → more B2B deals close. Target: one 500+ employee DFW employer by Q4.' },
                ].map(r => (
