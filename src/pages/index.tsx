...
const items = [
  { title: 'Rider Marketing', desc: '53+ marketing channels to acquire riders — social, paid ads, influencers, community, and more.', path: '/rider-marketing', tag: 'Growth', color: '#F59E0B', icon: 'M12 19l9 2-9-18-9 18 9-2zm0 0v-8' },
