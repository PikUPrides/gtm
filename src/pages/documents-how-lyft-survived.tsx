  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <div className="max-w-5xl mx-auto px-6 py-16 space-y-24">
        ...
        <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-red-900/40 via-slate-900 to-orange-900/30 border border-red-500/30 p-8 md:p-12">
          <div className="absolute top-0 right-0 w-80 h-80 bg-red-500/20 rounded-full blur-[100px]"></div>
          <div className="absolute bottom-0 left-0 w-80 h-80 bg-orange-500/20 rounded-full blur-[100px]"></div>
          <div className="relative">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-500/20 border border-red-500/40 text-red-300 text-sm font-bold mb-6">
              ⚠️ CONFIRMED: Empower Does NOT Provide Insurance
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-8">The Empower Insurance Time Bomb</h2>
            
            <div className="grid md:grid-cols-2 gap-6 mb-10">
              <div className="space-y-4">
                <div className="p-5 rounded-xl bg-slate-900/60 border border-slate-700/50">
                  <p className="text-slate-300 text-sm leading-relaxed">
                    <span className="text-red-400 font-semibold">From Empower's own FAQ:</span> "Empower does not currently provide insurance to drivers; however, we are working on establishing relationships with insurance carriers to help provide drivers with the most affordable options."
                  </p>
                  <p className="text-slate-500 text-xs mt-2 italic">Source: faq.driveempower.com</p>
                </div>
                <div className="p-5 rounded-xl bg-slate-900/60 border border-slate-700/50">
                  <p className="text-slate-300 text-sm leading-relaxed">
                    <span className="text-red-400 font-semibold">Class action lawsuit (Dec 2022):</span> "Empower neither supplies auto insurance to its drivers nor requires them to maintain any coverage of their own, and purportedly conducts no background checks of any kind on its drivers."
                  </p>
                  <p className="text-slate-500 text-xs mt-2 italic">Source: ClassAction.org</p>
                </div>
                <div className="p-5 rounded-xl bg-slate-900/60 border border-slate-700/50">
                  <p className="text-slate-300 text-sm leading-relaxed">
                    <span className="text-red-400 font-semibold">DC City Cast (Oct 2025):</span> They don't make drivers get commercial ride insurance (required for any non-personal driving), so if an accident happens, the rider could be left out to dry.
                  </p>
                  <p className="text-slate-500 text-xs mt-2 italic">Source: City Cast DC</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="p-5 rounded-xl bg-slate-900/60 border border-slate-700/50">
                  <p className="text-slate-300 text-sm leading-relaxed">
                    <span className="text-orange-400 font-semibold">Legal consequences:</span> Class action lawsuit in DC, Empower agreed to suspend ride operations in Washington D.C. NYC TLC set up a dedicated warning website. Drivers face $500 fines, vehicle owners up to $10,000.
                  </p>
                  <p className="text-slate-500 text-xs mt-2 italic">Source: Multiple sources</p>
                </div>
                <div className="p-5 rounded-xl bg-slate-900/60 border border-slate-700/50">
                  <p className="text-slate-300 text-sm leading-relaxed">
                    <span className="text-orange-400 font-semibold">Insurance comparison:</span> Uber and Lyft carry $1 million in bodily injury and property damage liability coverage when a driver is picking up or transporting a passenger. Empower carries none of this.
                  </p>
                  <p className="text-slate-500 text-xs mt-2 italic">Source: Blaszkow Legal, PLLC</p>
                </div>
                <div className="p-5 rounded-xl bg-slate-900/60 border border-slate-700/50">
                  <p className="text-slate-300 text-sm leading-relaxed">
                    <span className="text-yellow-400 font-semibold">The business model:</span> "The company's entire business model appears to have been designed to evade the insurance requirements set forth in that section [of D.C. code]."
                  </p>
                  <p className="text-slate-500 text-xs mt-2 italic">Source: ClassAction.org</p>
                </div>
              </div>
            ...
            {/* Summary Table */}
            <div className="overflow-hidden rounded-2xl border border-red-500/20 bg-slate-900/40 mb-10">
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-gradient-to-r from-red-900/40 to-orange-900/20">
                    <th className="text-left py-4 px-5 text-slate-300 font-bold">Question</th>
                    <th className="text-left py-4 px-5 text-red-400 font-bold">Answer</th>
                    <th className="text-left py-4 px-5 text-slate-400 font-bold">Source</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-700/30">
                  <tr className="hover:bg-slate-800/20">
                    <td className="py-3 px-5 text-slate-400">Does Empower carry a TNC commercial policy?</td>
                    <td className="py-3 px-5 text-red-400 font-semibold">No</td>
                    <td className="py-3 px-5 text-slate-500">Empower FAQ, Class action</td>
                  </tr>
                  <tr className="hover:bg-slate-800/20">
                    <td className="py-3 px-5 text-slate-400">Does Empower require drivers to have rideshare insurance?</td>
                    <td className="py-3 px-5 text-red-400 font-semibold">No — doesn't require OR verify</td>
                    <td className="py-3 px-5 text-slate-500">Class action lawsuit</td>
                  </tr>
                  <tr className="hover:bg-slate-800/20">
                    <td className="py-3 px-5 text-slate-400">Does Empower do background checks?</td>
                    <td className="py-3 px-5 text-red-400 font-semibold">No</td>
                    <td className="py-3 px-5 text-slate-500">Class action lawsuit</td>
                  </tr>
                  <tr className="hover:bg-slate-800/20">
                    <td className="py-3 px-5 text-slate-400">What happens in an accident?</td>
                    <td className="py-3 px-5 text-red-400 font-semibold">Rider and driver are on their own</td>
                    <td className="py-3 px-5 text-slate-500">TLC, injury attorneys</td>
                  </tr>
                  <tr className="hover:bg-slate-800/20">
                    <td className="py-3 px-5 text-slate-400">Has this caused legal trouble?</td>
                    <td className="py-3 px-5 text-red-400 font-semibold">Yes — class action, shut down in DC</td>
                    <td className="py-3 px-5 text-slate-500">Multiple sources</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-cyan-600/20 via-blue-600/20 to-purple-600/20 border border-cyan-500/30 p-6 md:p-8">
              ...
              <div className="relative">
                ...
                <p className="text-lg text-slate-300 leading-relaxed mb-4">
                  <span className="text-red-400 font-bold">This is 100% confirmed.</span> Empower's low prices are partly because they skip insurance entirely. That's a <span className="text-red-400 font-bold">ticking time bomb</span> — one fatal accident with no coverage and it's company-ending litigation.
                </p>
                <p className="text-xl text-white font-semibold">
                  AYRO's positioning is crystal clear:
                </p>
                <div className="mt-4 p-4 rounded-xl bg-slate-900/60 border border-cyan-500/30">
                  <p className="text-cyan-100 text-base leading-relaxed">
                    "Empower proved the demand for half-price rides. But they did it by skipping insurance — no coverage, no background checks, and they got shut down in DC and sued in a class action. <span className="text-white font-bold">AYRO delivers the same pricing but with full TNC insurance, full transparency, and full compliance.</span> We're Empower's economics done legally."
                  </p>
                </div>
              </div>
            </div>
