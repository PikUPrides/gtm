      ...
      <main className="pt-28 pb-16 px-4 sm:px-6 max-w-6xl mx-auto">
            ...
            <div className="px-6 sm:px-10 py-12">
              <div className="flex items-end justify-center gap-6 sm:gap-16 mb-10">
                ...
                <div className="flex flex-col items-center mb-4">
                  ...
                  <div className="mt-4 text-center">
                    <div className="text-base font-bold text-red-500">AYRO</div>
                    <div className="text-sm text-red-400">Austin only</div>
                    <div className="text-xs text-red-300 mt-1">~2.6M people</div>
                  </div>
                </div>
              </div>
        ...
        {activeSlide === 1 && (
          <div className="space-y-6">
            ...
            {/* Conclusion */}
            <div className="bg-gray-900 rounded-2xl px-6 sm:px-10 py-6">
              <div className="text-xs font-semibold text-[#08D9C4] uppercase tracking-wider mb-2">Conclusion</div>
              <p className="text-white text-sm leading-relaxed">
